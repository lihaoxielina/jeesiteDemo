...
<head>
	...
	<link href="<%=request.getContextPath() %>/static/uploadify/uploadify.css" rel="stylesheet" />
	<script src="<%=request.getContextPath() %>/static/uploadify/jquery.uploadify.min.js"></script>
